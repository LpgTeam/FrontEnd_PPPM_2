            ...
            <div class="row" data-aos="fade-up">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="text-end" style="margin-right: 10px">
                                <a href="/penelitian/download-proposal-akhir/<?= $reimburse['id_penelitian']; ?>/2"
                                    class="btn btn-primary">Download Proposal </a>
                                <!-- <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#proposal">Proposal</button> -->
                            </div>
                            <div class="text-end" style="margin-right: 10px">
                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#loa">LOA</button>
                            </div>
                            <div class="text-end" style="margin-right: 10px">
                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#naskah">Naskah Artikel</button>
                            </div>
                            <div class="text-end" style="margin-right: 10px">
                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#invoice">Invoice</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('/acc-reimburseBAU/' . $reimburse['id_reimburse']); ?>"
                            method="post">
                            <div class="row mb-3">
